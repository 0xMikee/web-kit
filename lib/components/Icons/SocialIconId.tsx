...
export enum SocialIconId {
    GITHUB = 'social-icon-github',
}
...
const getActionIconPath = (id: SocialIconId) => {
    switch (id) {
        case SocialIconId.GITHUB:
            return (
...
export const SocialIcon = ({ id, ...svgProps }: ActionIconProps) => (
